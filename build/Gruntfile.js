module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            ...
            bacon: {
                files: [
                    /*{
                        expand: true,
                        cwd: sourceDir + pkg.name + '/' + 'obj/Release/',
                        src: [
                            pkg.name + '.dll',
                            pkg.name + '.xml'
                        ],
                    ...
                    {
                        expand: true,
                        cwd: sourceDir + pkg.name, //sourceDir + pkg.name + '/Web/UI/App_Plugins/' + pkg.name,
                        src: ['**'],
		...
		nugetpack: {
            release: {
                src: 'config/package.nuspec', //projectDir + pkg.name + '.csproj',
